...
const Tickets = () => {
  ...
  const breachedTickets = tickets.filter((ticket) => ticket.slaBreached).length;
  ...
  const filteredTickets = useMemo(() => {
    return tickets.filter((ticket) => {
      ...
      return (
        matchesStatus && matchesPriority && matchesCategory && matchesEscalation
      );
    });
  }, [tickets, statusFilter, priorityFilter, categoryFilter, escalatedFilter]);
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [statusFilter, priorityFilter, categoryFilter, escalatedFilter]);
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 xl:grid-cols-6">
          ...
          <div className="flex min-w-0 items-center gap-4 rounded-xl bg-white p-5 shadow">
            ...
            <div className="min-w-0">
              <p className="text-xs font-semibold text-gray-500">Escalated</p>
