...
import { FaTimes, FaExclamationTriangle, FaDownload} from "react-icons/fa";
          ...
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center gap-2">
              <PDFDownloadLink
                ...
                fileName={`${order.invoiceNumber || `INV-${order.orderNumber || order._id}`}.pdf`}
                className="flex items-center gap-2 rounded-lg bg-[#6547C9] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#5638B5]"
              >
                {({ loading }) => (
                  <>
                    <FaDownload />
            ...
            <div className="flex flex-col justify-between gap-6 rounded-xl border border-gray-200 p-4 sm:flex-row">
              ...
              <div className="w-full max-w-xs space-y-2 text-sm">
                <div className="flex justify-between text-gray-600">
                  ...
                  <span>
                    ₹
                    {Number(order.subtotal || order.totalAmount || 0).toFixed(
                      2,
                    )}
                  </span>
                </div>
